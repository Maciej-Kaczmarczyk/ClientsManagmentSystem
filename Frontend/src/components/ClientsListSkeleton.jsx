...
function SkeletonItem() {
  return (
    <li className="flex animate-pulse items-center justify-between gap-4 border-t-[1px] bg-white px-8 py-8 hover:cursor-pointer hover:bg-white dark:bg-zinc-800">
