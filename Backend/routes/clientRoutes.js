...
router.post('/', async (req, res) => {
    try {
        ...
        await db.query('INSERT INTO clients (firstname, lastname, address, city, zip_code, email, phone) VALUES ($1, $2, $3, $4, $5, $6, $7)', [firstname, lastname, address, city, zip_code, email, phone]);
